...
//struct GameObject
//{
//	GameObject(string name, int health, int damage);
//
//	string name;
//	int health;
//	int damage;
//
//	virtual void Attack(GameObject& character)
//	{
...
int main()
{
    Player player{ "Winton", 100, 25 };
	savePlayerData(player);
	Player loadedPlayer;
	loadPlayerData(loadedPlayer);
	cout << loadedPlayer.name << " " << loadedPlayer.health << " " << loadedPlayer.damage << endl;
	return 0;
}
